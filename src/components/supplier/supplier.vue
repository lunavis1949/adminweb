  ...
  <div class="vip">
    ...
    <el-row style="background:#ffffff;padding:15px;">
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple titlr_bot" >
            <el-row>
              ...
              <el-button :type="add_but" size="mini" icon="el-icon-edit" @click="edit_play">编辑</el-button>
      ...
      <el-row>
        ...
        >
          <el-table-column align="center" prop="id" sortable label="供应商ID" width="120"></el-table-column>
          <el-table-column align="center" prop="uid" sortable label="用户ID" width="100"></el-table-column>
          <el-table-column align="center" prop="title" label="标题" width="130"></el-table-column>
          <el-table-column align="center" prop="area" label="地区" width="100"></el-table-column>
      ...
      <el-row type="flex" justify="end">
        <el-col :span="24" class="pading_none none_title">
          <div>
            ...
            <el-col :span="12">
              <div class="grid-content bg-purple-dark" style="text-align: right;"@click="sendMsg">
...
export default {
  ...
  methods: {
    ...
    onLonds(pages, limit, status) {
      ...
      this.$axios
        .post(this.api.getSupplierList, data)
        .then(res => {
    ...
    handleClick(e) {
      ...
      this.show2 = true;
      this.user_id = e.id;
      this.formLabelAlign[0] = e.title;
      this.formLabelAlign[1] = e.area;
    ...
    confirmDelete(row) {
      ...
      that.$axios
        .post(this.api.delSupplier, data)
        .then(res => {
    ...
    ok_http() {
      ...
      this.$axios
        .post(this.api.editSupplier, data)
        .then(res => {
          console.log(res);
          if (res.data.success == true) {
            this.show2 = false;
